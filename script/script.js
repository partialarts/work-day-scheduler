...
$(function () {
    ...
    // Listens for click on any element with #clearBtn ID
    $("#clearBtn").on("click", function (event) {
        localStorage.clear(); // Clears local storage on click
        location.reload(); // Reloads the page after storage has been cleared
    });

    // Listens for click on any element with .saveBtn class
